        ...
        <div class="max-w-5xl mx-auto md:flex md:gap-10">
            ...
            <div class="w-full">
                ...
                <div class="flex justify-center mb-6">
                    <img src="{{ asset('images/education-sub1.jpg') }}" alt="Main Politics"
                ...
                <div class="md:flex md:gap-10 px-4">
                    ...
                    <div class="md:w-2/3 space-y-6 text-[15px] leading-relaxed text-justify text-gray-800">
                        ...
                        <p>
                            Education is more than just textbooks and classrooms—it's about joy, curiosity, and the freedom to dream. This photo captures the radiant energy of young Indonesian students, filled with hope and laughter as they embark on their daily journey of learning.                        </p>
                        <p>
                            For many children, school is a second home where friendships are formed, creativity is sparked, and confidence begins to grow. It’s a space where they are empowered to ask questions, to explore, and to imagine a brighter future beyond the classroom walls.                        </p>
                        <p>
                            In communities around the world, access to quality education remains a powerful tool to break the cycle of poverty and inequality. These smiling faces remind us of the potential that lies in every child when they are given the chance to learn and thrive.                        </p>
                        <p>
                            Let this image be a symbol of what education can achieve—a generation full of promise, resilience, and unstoppable spirit. Because when children are supported, the future becomes limitless.                        </p>
                    </div>
                    {{-- Sidebar --}}
                ...
                <div class="md:w-2/3 space-y-6 text-[15px] leading-relaxed text-justify text-gray-800">
                    ...
                    {{-- Gambar --}}
                    <div class="flex justify-center mb-6">
                        <img src="{{ asset('images/education-sub2.jpg') }}" alt="politics-sub2"
                            class="rounded-lg object-cover"
                            style="width: 1050px; height: 423px;">
                    </div>
                    ...
                    <div class="space-y-6 text-[15px] leading-relaxed text-justify text-gray-800">
                        ...
                        <p>
                            Every classroom holds the heartbeat of the future—curious minds, eager hands, and the dedicated teachers who guide them. This photo perfectly captures that magic: a moment where learning becomes exciting, and questions are welcomed with joy.                        </p>
                        <p>
                            The students, dressed in their red-and-white uniforms and traditional headbands, are not just learning facts—they're learning how to think, speak, and express themselves with confidence. Their raised hands show more than answers; they show courage, engagement, and a desire to grow.                        </p>
                        <p>
                            At the heart of this scene is the teacher, whose smile radiates patience and encouragement. She isn’t just delivering lessons—she’s nurturing dreams and building trust, one student at a time. This connection is what transforms education into empowerment.                        </p>
                        <p>
                            Scenes like this remind us that real education is interactive, inspiring, and full of life. When students are supported and inspired, they don't just absorb knowledge—they become the leaders, thinkers, and creators of tomorrow.               </p> 
                    </div>
                </div>
